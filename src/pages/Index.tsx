  ...
  return (
    <div className='min-h-screen flex flex-col bg-blue-50'>
        ...
        {appState === AppState.REVEAL && (
          <div className='w-full mb-8'>
            <iframe
              ...
              allowFullScreen
              className='rounded-lg shadow-md max-w-xl mx-auto'></iframe>
          </div>
        )}
          ...
          {appState === AppState.UPLOAD && (
            <div className='animate-fade-in space-y-8'>
              ...
              <div className='mb-8 text-center'>
                <h1 className='text-5xl md:text-6xl font-bold mb-4 anime-title text-black line-clamp-2'>
                  Ghibli Art Generator
                </h1>
                <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
                  Why just ads? We can even make your visuals look great. Let's add that anime touch
                  now ⬇️
                </p>
              </div>
      ...
      <footer className='py-4 text-center text-sm text-gray-500 bg-white border-t'>
        <p>© 2025 UndrAds. Ad optimizers at ❤️.</p>
      </footer>
